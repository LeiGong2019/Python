...
# 安装 pip install selenium  ; 安装完成后，Selenium需要配合webdriver才能使用，webdriver下载放置在任意非中文路径的文件夹下即可；
# 下载网址： https://registry.npmmirror.com/binary.html?path=chromedriver/,
#  选择一个和浏览器版本契合或最近的文件； 如chorme是101.0.4951.54，修改浏览器快捷方式中的目标，添加 --remote-debugging-port=6001
